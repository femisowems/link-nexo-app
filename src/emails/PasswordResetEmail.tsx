                                ...
                                <tr>
                                    <td style={{ padding: "40px 40px 32px" }}>
                                        ...
                                        <p style={{ fontSize: 15, color: "#475569", lineHeight: 1.6, margin: "0 0 28px" }}>
                                            We received a request to reset your Link Nexo password. Click the button below to choose a new one. This link expires in <strong>1 hour</strong>.
                                        </p>
                                        <a
                                            href={resetUrl}
                                            style={{
                                ...
                                <tr>
                                    <td style={{ background: "#f1f5f9", padding: "16px 40px", textAlign: "center" }}>
                                        <p style={{ fontSize: 12, color: "#94a3b8", margin: 0 }}>
                                            ...
                                            <span style={{ wordBreak: "break-all", color: "#64748b" }}>{resetUrl}</span>
                                        </p>
                                    </td>
                                </tr>
                            </table>
